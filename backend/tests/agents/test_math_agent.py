...
class TestSolveMath:
    ...
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_successful_solve_math(self, mock_chat_openai):
        ...
        result = solve_math("2 + 3")
        assert result == "5"

    def test_solve_math_missing_api_key(self):
        """Test solve_math when API key is missing."""
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_solve_math_llm_error(self, mock_chat_openai):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_solve_math_various_expressions(self, mock_chat_openai):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_calculation_with_answer_prefix(self, mock_chat_openai):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_calculation_with_negative_number(self, mock_chat_openai):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_calculation_with_decimal_number(self, mock_chat_openai):
        ...
        result = solve_math("pi")
        assert result == "3.14159"

    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_invalid_expression_error(self, mock_chat_openai):
        ...
        with pytest.raises(ValueError, match="Could not evaluate the expression"):
            solve_math("invalid expression")

    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_empty_response_handling(self, mock_chat_openai):
...
class TestEdgeCases:
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_very_long_expression(self, mock_chat_openai):
        ...
        result = solve_math(long_expression)
        assert result == "55"

    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_expression_with_special_characters(self, mock_chat_openai):
...
class TestErrorHandling:
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_llm_timeout_error(self, mock_chat_openai):
    ...
    @patch.dict(os.environ, {"OPENAI_API_KEY": "test-key"})
    @patch("app.agents.math_agent.ChatOpenAI")
    def test_llm_rate_limit_error(self, mock_chat_openai):
